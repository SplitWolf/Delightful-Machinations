...
import {$MobSoulUtils, $MobSoulUtils$Type} from "packages/com/blakebr0/mysticalagriculture/api/util/$MobSoulUtils"
...
declare global {
const CropTier: typeof $CropTier
...
const MobSoulUtils: typeof $MobSoulUtils
const Crop: typeof $Crop
...
const CropRecipes: typeof $CropRecipes
...
const CropType: typeof $CropType
const CropTextures: typeof $CropTextures
