...
import {$ByteBuffer, $ByteBuffer$Type} from "packages/java/nio/$ByteBuffer"
import {$BufferBuilderAccessor as $BufferBuilderAccessor$0, $BufferBuilderAccessor$Type as $BufferBuilderAccessor$0$Type} from "packages/team/creative/creativecore/mixin/$BufferBuilderAccessor"
import {$VertexFormat, $VertexFormat$Type} from "packages/com/mojang/blaze3d/vertex/$VertexFormat"
...
public "handler$cge000$onInit"(bufferSizeIn: integer, ci: $CallbackInfo$Type): void
public "localvar$bbd000$vertex"(alpha: float): float
public "iris$currentLocalPosX"(): integer
public "sodium$getFormatDescription"(): $VertexFormatDescription
public "setIsFlyWheelBufferBuilder"(arg0: boolean): void
